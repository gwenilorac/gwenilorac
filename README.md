...
[![My Skills](https://skillicons.dev/icons?i=java,bash,hibernate,git,postgres,mysql,nginx,spring,gradle,docker,aws,maven,linux,kali,vscode,eclipse,&perline=8)](https://skills.thijs.gg)
<h2> About me: </h2>
 <ul>
