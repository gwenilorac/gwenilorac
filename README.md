...
[![My Skills](https://skillicons.dev/icons?i=html,css,javascript,typescript,angular,java,spring,hibernate,postgres,mysql,nginx,gradle,maven,docker,bash,linux,kali,vscode,eclipse,androidstudio,git,gitlab,ubuntu,windows&perline=7)](https://skills.thijs.gg)
<h2> About me: </h2>
 <ul>
