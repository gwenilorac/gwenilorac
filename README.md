...
[![My Skills](https://skillicons.dev/icons?i=java,spring,hibernate,postgres,mysql,nginx,gradle,maven,docker,bash,linux,kali,vscode,eclipse,ubuntu,windows&perline=8)](https://skills.thijs.gg)
<h2> About me: </h2>
 <ul>
